...
export const AiIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-cyan-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17L17.25 21A2.652 2.652 0 0021 17.25l-5.877-5.877M11.42 15.17l2.496-3.03c.317-.384.73-.626 1.18-.766l-2.496-3.03m0 0l-5.877-5.877A2.652 2.652 0 003.75 6l5.877 5.877m0 0l2.496 3.03" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 19.5l7.125-7.125" />
    </svg>
);
